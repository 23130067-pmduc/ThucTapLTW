...
public class InventoryTransactionStatusController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        } else if ("INSUFFICIENT_BATCH_STOCK".equals(result)) {
            response.sendRedirect(request.getContextPath() + redirect + appendParam(redirect, "error=insufficient_batch_stock"));
