...
<head>
    ...
    <title>Admin - Thêm mã giảm giá</title>
            ...
            <section class="voucher-form-card">
                <div class="form-title-row">
                    <div>
                        ...
                        <p>Nhập đầy đủ thông tin để mã có thể hiển thị và áp dụng trên hệ thống.</p>
                    </div>
                    <span class="form-badge">Issue 110</span>
                </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <select id="status" name="status">
                                <option value="1" ${voucher.status != 0 ? 'selected' : ''}>Mở</option>
                                <option value="0" ${voucher.status == 0 ? 'selected' : ''}>Khóa</option>
                            </select>
                        </div>
