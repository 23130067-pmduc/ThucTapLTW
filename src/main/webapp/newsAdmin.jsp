...
<head>
    ...
    <title>Tin tức</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/news-admin.css?v=20260612">
...
<div class="user">
    <aside class="sidebar">
        ...
        <div class="nav">
            ...
            <a href="${pageContext.request.contextPath}/news-admin" class="nav-item active"><i class="fa-solid fa-newspaper"></i><span>Tin tức</span></a>
