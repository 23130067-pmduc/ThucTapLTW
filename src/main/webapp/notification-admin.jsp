...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/css/notification-admin.css?v=20260612">
...
<div class="user">
  <aside class="sidebar">
    ...
    <div class="nav">
      ...
      <a href="${pageContext.request.contextPath}/notification-admin" class="nav-item active"><i class="fa-solid fa-bell"></i><span>Thông báo</span></a>
